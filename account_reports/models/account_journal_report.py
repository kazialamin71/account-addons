...
class JournalReportCustomHandler(models.AbstractModel):
    ...
    def _custom_options_initializer(self, report, options, previous_options=None):
        ...
        elif available_journal_ids and not any_unfolded_journal and options['export_mode'] != 'print':
    ...
    def _query_journal(self, options):
        ...
        for journal_res in self.env.cr.dictfetchall():
        ...
        for column_group_key, options_group in report._split_options_per_column_group(options).items():
            ...
            queries.append(f"""
                SELECT
                    ...
                    acc.code_store->>SPLIT_PART(cp.parent_path, '/', 1) as account_code,
