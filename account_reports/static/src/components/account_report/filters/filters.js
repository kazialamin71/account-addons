...
import { LegacyDropdown as Dropdown } from "@account_reports/components/account_report/legacy_dropdown/legacy_dropdown";
...
export class AccountReportFilters extends Component {
    ...
    async filterTaxUnit(taxUnit) {
        ...
        await user.activateCompanies(taxUnit.company_ids, {
